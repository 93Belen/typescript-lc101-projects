...
//onsole.log(`${spacecraftName} will take ${getDaysToLocation(kilometersToTheMoon)} days to get to The Moon`);
...
var Spacecraft = /** @class */ (function () {
    ...
    Spacecraft.prototype.getDaysToLocation = function (kilometersAway) {
        ...
        console.log("".concat(this.name, " would take ").concat(daysToLocation, " to get to destination"));
        return daysToLocation;
    };
    return Spacecraft;
}());
